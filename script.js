// DATA JSON copy từ API (KHÔNG fetch)
const data = [ 
  {
    "id": 160,
...
// Constructor Object
function Product(id, title, slug, price, description, category, image) {
  this.id = id;
  this.title = title;
  this.slug = slug;
  this.price = price;
...
products.forEach(p => {
  ...
  tr.innerHTML = `
    ...
    <td>${p.category}</td>
    <td>
      <img src="${p.image}" onerror="this.src='https://placehold.co/40x40'">
    </td>
  `;
